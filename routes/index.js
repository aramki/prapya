...
router.get('/map', storeController.displayMap);
...
// API Endpoints
router.get('/apiv1/search', catchErrors(storeController.searchStores));
router.get('/apiv1/stores/around', catchErrors(storeController.mapStores));
router.post('/apiv1/stores/:id/heart', catchErrors(storeController.heartStore));
